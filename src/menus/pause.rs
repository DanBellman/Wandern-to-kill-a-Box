...
fn spawn_pause_menu(mut commands: Commands) {
    commands.spawn((
        ...
        children![
            ...
            widget::button("Save / Load", open_save_load_menu),
...
fn open_save_load_menu(_: Trigger<Pointer<Click>>, mut next_menu: ResMut<NextState<Menu>>) {
    next_menu.set(Menu::SaveLoad);
}
